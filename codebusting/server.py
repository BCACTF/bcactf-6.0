...
def generate_test_pairs():
    l = [
        ...
        "3 D", "3 E", "3 C", "4 D", "4 E", "5 D", "5 E", "5 C",
        "8 1", "8 1", "13 E", "13 D", "13 C",
    ]
    n = len(l)
    q = genQuotes(n + 1)
    pairs = []
